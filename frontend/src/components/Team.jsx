...
const Team = () => {
      ...
      <div className='p-4 md:space-y-8 space-y-6 flex flex-col items-center border border-red-500'>
        <div className='flex flex-col items-center md:gap-7 gap-4'>
          ...
          <div className='md:space-y-3 space-y-2'>
            <h3 className='leading-[2.2rem] text-center'>{name}</h3>
        ...
        <p className='italic w-full max-w-xs text-center'>"{quote}"</p>
        <div className='space-y-3'>
          <p className='text-xs text-center text-neutral-500'>Socials:</p>
          <div className='md:space-x-3 space-y-1.5'>
            {socials.map((social, index) => (
              <a key={index} target='_blank' rel='noopener noreferrer' href={social.link} className='inline-flex hover:bg-neutral-200/30 group p-2 rounded-md transition duration-300 ease-in-out'>
  ...
  return (
    <section className='md:px-20 md:py-24 py-12 px-8 md:space-y-12 space-y-8'>
      <h2 className='text-center'>Our Talented Team</h2>
      <div className='grid lg:grid-cols-3 grid-cols-1 gap-x-0 lg:gap-x-16 md:gap-y-16 gap-y-8'>
        {/* Lian Torres */}
        <div>
          <ProfileCard
            ...
            roles={['Founder', 'Lead Programmer', 'Back-end Developer']}
            socials={
              [
                {
        ...
        {/* Seperate Container */}
        <div className='col-span-2 grid md:grid-cols-2 grid-cols-1 md:gap-16 gap-8'>
          {/* Frederick Moreno */}
          <ProfileCard
            profile={'https://media.tenor.com/yskj0PnyEpoAAAAM/borpynino.gif'}
