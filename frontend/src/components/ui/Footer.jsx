    ...
    <footer className='flex md:flex-row flex-col md:gap-0 gap-8 md:justify-between justify-center md:items-end items-center md:px-24 px-4 md:py-12 py-6'>
      ...
      <div className='flex flex-col items-center md:items-start gap-5'>
        ...
        <div className='flex flex-col items-center md:items-start gap-4'>
          ...
          <p className='w-full max-w-md md:text-start text-center border border-yellow-500'>Test push Test push Test pusgh Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis explicabo elit dignissimos deleniti voluptas assumenda porro recusandae quo sunt? Reprehenderit.</p>
